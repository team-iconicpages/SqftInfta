...
<head>
    ...
    <title>SQFTinfra | Queries & Leads</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <p class="text-2xl font-semibold mb-4">Queries & Leads</p>
                <div class="overflow-x-auto">
                    <table id="myTable" class="display min-w-full bg-white shadow-md rounded-lg">
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            ...
                            $sql = "SELECT sno, name, email, phone, message FROM contact_form ORDER BY sno DESC";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td class='py-3 px-6 text-left whitespace-nowrap'>{$row['phone']}</td>";
                                    echo "<td class='py-3 px-6 text-left whitespace-nowrap'>" . implode(' ', array_slice(explode(' ', $row['message']), 0, 10)) . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='5' class='py-3 px-6 text-center'>No data available</td></tr>";
                            }
                            $conn->close();
                            ?>
                        </tbody>
